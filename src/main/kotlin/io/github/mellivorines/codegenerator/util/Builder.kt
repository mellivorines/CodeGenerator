...
import io.github.mellivorines.codegenerator.meta.Column
...
import io.github.mellivorines.codegenerator.model.setting.Language
...
fun buildTable(
    ...
    columns.forEach {
        ...
        val jvmTypeName = if (lang == Language.Kotlin) jvmType.simpleName else {
            jvmType.javaObjectType.simpleName
